...
bool MeshEx::removeVertexAndReTriangulateNeighbourhood( Vertex *v )
{
	...
	do
	{
		...
		case  1:normal = math::normalize( math::Vec3d( .8507f, .4472f, .2764f ));break;
		case  2:normal = math::normalize( math::Vec3d( -.8507f, .4472f, .2764f ));break;
		case  3:normal = math::normalize( math::Vec3d( .8507f, -.4472f, -.2764f ));break;
		case  4:normal = math::normalize( math::Vec3d( -.8507f, -.4472f, -.2764f ));break;
		case  5:normal = math::normalize( math::Vec3d( .5257f, -.4472f, .7236f ));break;
		case  6:normal = math::normalize( math::Vec3d( .5257f, .4472f, -.7236f ));break;
		case  7:normal = math::normalize( math::Vec3d( -.5257f, -.4472f, .7236f ));break;
		case  8:normal = math::normalize( math::Vec3d( -.5257f, .4472f, -.7236f ));break;
		case  9:normal = math::normalize( math::Vec3d( .0f, .4472f, .8944f ));break;
		case 10:normal = math::normalize( math::Vec3d( .0f, -1.0f, .0f ));break;
	...
	do
	{
		...
		for( std::vector<Edge *>::iterator it = m_edges.begin(); it != m_edges.end(); ++it )
		{
			...
			if( e->isBoundaryEdge() )
			{
				...
				auto interiorPoints = std::vector<std::pair<math::Vec3d, math::Vec2d> >();
