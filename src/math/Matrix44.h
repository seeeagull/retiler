...
namespace math
{
	...
	struct Matrix44
	{
		...
		static Matrix44<T>                                          RotationMatrixX( const T &angle );  ///< returns a matrix which defines a rotation around the x axis with the double-specified amount
		static Matrix44<T>                                          RotationMatrixY( const T &angle );  ///< returns a matrix which defines a rotation around the y axis with the double-specified amount
		static Matrix44<T>                                          RotationMatrixZ( const T &angle );  ///< returns a matrix which defines a rotation around the z axis with the double-specified amount
